...
I chose to explore the FAQ page on the [Nintendo Switch website](https://www.nintendo.com/us/switch/faq/). One immediate positive I noticed is how the page splits the FAQ into several sections, such as the different Nintendo Switch models, games and accessories, and the console's Online Service. It makes it much easier for the user to find the information they need. Another positive is that the information is laid out very clearly, with a list of questions spereated into relevant sections with the answers given in a collapsible tab. It's avery simple but effective layout for finding important information.

One negative I noticed is that if the user can't find the information they need on the FAQ page, there's no immediatly clear link to a support page where they would be able to get more help with their issue. Another negative is that some sections are noticably smaller than others, to the point where its quistonable why they're even included as a distinct section. The biggest example of this is the Nintendo Switch ONline section, which consists of only one question. It makes the page even slightly more complicated for no reason.
