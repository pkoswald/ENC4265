...
One problem is the possibility of the information it gives the user being incorrect. While I was able to get my chatbot to give mostly accurate information after some trial and error, there were still some questions I asked where the answer it gave me wasn’t accurate. This is a problem because the AI is unable to say that it isn't certain about the answer, so it will parrot wrong information as though it is true. In customer service use, the chatbot may not be able to provide any answers to a user's question and instead redirect them to a human representative, which makes it useless.
...
AI Statement: Spellcheck was used in making this reflective blog.

# Reflective Blog 7

### Prompt : Explore an online tutorial, manual, or reference guide/FAQ page. Give it an honest but professional assessment. Describe in your post the aspects of the page(s) that are effective, and explain why. Describe the aspects of the page(s) that are ineffective, and explain why. Keep a professional tone, as though you expect the author(s) of the page(s) to read your post. 

I chose to explore the FAQ page on the [Nintendo Switch website](https://www.nintendo.com/us/switch/faq/). One immediate positive I noticed is how the page splits the FAQ into several sections, such as the different Nintendo Switch models, games and accessories, and the console's Online Service. It makes it much easier for the user to find the information they need. Another positive is that the information is laid out very clearly, with a list of questions separated into relevant sections with the answers given in a collapsible tab. It's a very simple but effective layout for finding important information.

One negative I noticed is that if the user can't find the information they need on the FAQ page, there's no immediately clear link to a support page where they would be able to get more help with their issue. Another negative is that some sections are noticeably smaller than others, to the point where it’s questionable why they're even included as a distinct section. The biggest example of this is the Nintendo Switch Online section, which consists of only one question. It makes the page even slightly more complicated for no reason.

The biggest negative is that the FAQ is geared towards people who have not yet purchased the system as opposed to people who already own the system and are having trouble with it. There are no questions related to resolving issues such as the console not turning on. Similarly to the GameStop FAQ page, it makes it feel a bit too much like an advertisement for the system instead of a page to help users.

Overall, while the FAQ page is pretty good for people who are interested in purchasing the system and want to know more specific details about it, it does little to help users who already own the system and want help with using it.
